...
public class SudokuGui extends JFrame {
    ...
    private void askForSolvedFile() {
        JOptionPane.showMessageDialog(this, "No incomplete game or full set found. Please select a solved Sudoku CSV file.");
    ...
    private void onUndo() {
        if (!undoStack.isEmpty()) {
            ...
            cells[action.getRow()][action.getCol()].setText(action.getPreviousValue() == 0 ? "" : Integer.toString(action.getPreviousValue()));
        } else {
